...
def balance_SMOTE(data, strategy: str, plot, random_state=42):
    ...
    values = {
        "Original": [target_count.values[ind_min_class], target_count.values[1 - ind_min_class]]
    }
...
def run(trnX, trnY, strategy: str, random_number, plot):
    ...
    df_trn = balance_SMOTE(
        df_trn, strategy, plot, random_number
